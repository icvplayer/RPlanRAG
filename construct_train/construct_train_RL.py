...
if __name__ == "__main__":
    ...
    parser.add_argument("--working_dir", type=str, default=f"./mydata_results_RL/{cls}", help="The path to storage results")
    parser.add_argument("--eval_data", type=str, default="./training_summarize_data/my_training_data_RL.json", help="The path of the dataset")
