...
from freestyleRAG.llm import ollama_model_complete, ollama_embedding, openai_complete_if_cache, hf_model_complete
...
cls = os.getenv("data_name")  # ['hotpotqa', '2wikimqa', 'musique']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--working_dir", type=str, default=f"./longbench_results/{cls}_longbench", help="The path to storage results")
    parser.add_argument("--eval_data", type=str, default="../data/longbench.json", help="The path of the dataset")
